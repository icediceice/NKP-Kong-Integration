...
The NKP Insights Architecture diagram shows how NKP Managed Clusters generate events and
      ...
      and best practices. Figure. NKP Insights Architecture Click to enlarge<!-- source: top-nkp-installation-prerequisites-c.html -->
...
For attaching existing clusters without networking restrictions, the requirements depend on
      ...
      version.<!-- source: top-nutanix-custom-create-mgmtcluster-t.html -->
