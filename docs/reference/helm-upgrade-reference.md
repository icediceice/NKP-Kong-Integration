[Skip to main content](https://helm.sh/docs/helm/helm_upgrade/#__docusaurus_skipToContent_fallback)
🎉 Helm v4.0.0 is out! See the [Helm 4 Overview](https://helm.sh/docs/overview) for details!
[![Helm Logo](https://helm.sh/img/helm.svg) **Helm**](https://helm.sh/)[Docs](https://helm.sh/docs)[Community](https://helm.sh/community)[Blog](https://helm.sh/blog)[Charts](https://artifacthub.io/)
[4.0.0](https://helm.sh/docs/helm/helm_upgrade)
  * [4.0.0](https://helm.sh/docs/helm/helm_upgrade)
  * [3.19.0](https://helm.sh/docs/v3/helm/helm_upgrade)
  * [2.17.0](https://helm.sh/docs/v2/helm/helm_upgrade)


[](https://helm.sh/docs/helm/helm_upgrade/)
  * [English](https://helm.sh/docs/helm/helm_upgrade)
  * [Deutsch (German)](https://helm.sh/de/docs/helm/helm_upgrade)
  * [Ελληνικά (Greek)](https://helm.sh/el/docs/helm/helm_upgrade)
  * [Español (Spanish)](https://helm.sh/es/docs/helm/helm_upgrade)
  * [Français (French)](https://helm.sh/fr/docs/helm/helm_upgrade)
  * [日本語 (Japanese)](https://helm.sh/ja/docs/helm/helm_upgrade)
  * [한국어 (Korean)](https://helm.sh/ko/docs/helm/helm_upgrade)
  * [Português (Portuguese)](https://helm.sh/pt/docs/helm/helm_upgrade)
  * [Русский (Russian)](https://helm.sh/ru/docs/helm/helm_upgrade)
  * [Українська (Ukrainian)](https://helm.sh/uk/docs/helm/helm_upgrade)
  * [中文 (Chinese)](https://helm.sh/zh/docs/helm/helm_upgrade)
...
# helm upgrade
upgrade a release
### Synopsis[​](https://helm.sh/docs/helm/helm_upgrade/#synopsis "Direct link to Synopsis")
...
### Options[​](https://helm.sh/docs/helm/helm_upgrade/#options "Direct link to Options")
```
...
### Options inherited from parent commands[​](https://helm.sh/docs/helm/helm_upgrade/#options-inherited-from-parent-commands "Direct link to Options inherited from parent commands")
```
...
### SEE ALSO[​](https://helm.sh/docs/helm/helm_upgrade/#see-also "Direct link to SEE ALSO")
  * [helm](https://helm.sh/docs/helm/helm) - The Helm package manager for Kubernetes.


###### Auto generated by spf13/cobra on 14-Jan-2026[​](https://helm.sh/docs/helm/helm_upgrade/#auto-generated-by-spf13cobra-on-14-jan-2026 "Direct link to Auto generated by spf13/cobra on 14-Jan-2026")
[](https://github.com/helm/helm-www/blob/main/docs/helm/helm_upgrade.md)
[Previous helm uninstall](https://helm.sh/docs/helm/helm_uninstall)[Next helm verify](https://helm.sh/docs/helm/helm_verify)
  * [Synopsis](https://helm.sh/docs/helm/helm_upgrade/#synopsis)
  * [Options](https://helm.sh/docs/helm/helm_upgrade/#options)
  * [Options inherited from parent commands](https://helm.sh/docs/helm/helm_upgrade/#options-inherited-from-parent-commands)
  * [SEE ALSO](https://helm.sh/docs/helm/helm_upgrade/#see-also)
...
![CNCF Logo](https://helm.sh/img/cncf-white.png)
